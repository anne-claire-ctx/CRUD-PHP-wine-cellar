...
<section id="pageErreur" style="background:black; height:100vh margin:0;">
    <div class="error" role="dialog">
        <p>Oups, impossible de trouver la page... vous pouvez rester ici ou <a href="http://localhost/Nouveau-projet/dashboard" class="btns btnswhite">revenir chez nous</a></p>
